...
import { testTraillists, lenister } from "../fixtures.js";
...
suite("Traillist Model tests", () => {
    ...
    test("create a traillist", async () => {
        const traillist = await db.traillistStore.addTraillist(lenister);
        //assert.equal(lenister, traillist);
        assertSubset(lenister, traillist);
